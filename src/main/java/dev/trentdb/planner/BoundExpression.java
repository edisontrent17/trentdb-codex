...
public sealed interface BoundExpression permits BoundAggregateExpression, BoundBinaryExpression, BoundColumnRefExpression,
        ...
        BoundOutputColumnExpression, BoundCaseExpression, BoundNullCheckExpression, BoundIntervalExpression, BoundSubqueryExpression,
        BoundInSubqueryExpression, BoundExistsSubqueryExpression {
}
